        ...
        <form className="mt-8 space-y-6" onSubmit={formik.handleSubmit}>
          ...
          <div className="-space-y-px rounded-md">
            <input
              ...
              className="border-black-700 border text-gray-900 placeholder-black-300 focus:ring-gray-500
              focus:border-gray-500 block w-full
              pr-10 focus:outline-none sm:text-sm rounded-md m-2"
            />
            <input
